...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPay_demo:(NSString *)prepareid
{
//
//    //订单标题，展示给用户
...
//    //订单金额,单位（分）
//    NSLog(@"^^^^^^^^^^^^^^^^%@",price);
//    NSString *order_price   =[NSString stringWithFormat:@"%.0f",[price floatValue]] ;//1分钱测试
//
//    //================================
//    //预付单参数订单设置
//    //================================
//    srand( (unsigned)time(0) );
//    NSString *noncestrs  = [NSString stringWithFormat:@"%d", rand()];
...
//    [packageParams setObject: tradeOrder           forKey:@"out_trade_no"];//商户订单号
