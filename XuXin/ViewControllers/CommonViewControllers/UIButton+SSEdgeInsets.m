...
//    return CGRectMake(0, 0, contentRect.size.width/2.0f, contentRect.size.height/2.0f);
//}
//-(CGRect)titleRectForContentRect:(CGRect)contentRect{
//    return CGRectMake(0, contentRect.size.height/2.0f, contentRect.size.width/2.0f, contentRect.size.height/2.0f);
//}
@end
