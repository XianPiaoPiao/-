...
NSString * const trueMethodIndertfier4 = @"TrueMethodTableViewCell";

@interface CashPayViewController ()<UITableViewDelegate,UITableViewDataSource>
...
-(void)creatUI{
    ...
    [tableView registerNib:[UINib nibWithNibName:@"TrueMethodTableViewCell" bundle:nil] forCellReuseIdentifier:trueMethodIndertfier4];
    ...
    [surePayBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(self.view.mas_bottom).offset(-80-self.TabbarHeight);
    }];
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    CashPayTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:@"CashPayTableViewCell"];
    cell.contentView.backgroundColor = [UIColor colorWithHexString:MainColor];
    cell.totalLabel.text = [NSString stringWithFormat:@"￥ %@",_intergralPoint];
    cell.postLabel.text = [NSString stringWithFormat:@"%@",_sendPrice];
    cell.cashLabel.text = [NSString stringWithFormat:@"%@",_cash];
    return cell;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
        ...
        TrueMethodTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:trueMethodIndertfier4 forIndexPath:indexPath];
