//
//  HDConvertController.m
//  XuXin
//
//  Created by xuxin on 17/5/10.
...
#import "ConvertOneCollectionViewCell.h"
#import "ConvertTwoCollectionViewCell.h"
#import "ConvertCollectionReusableView.h"
...
NSString  *const  GradeIdertiferTest = @"GradeCollectionViewCell";
NSString  *const  GradeIdertiferTest2 = @"ConvertOneCollectionViewCell";
NSString  *const  GradeIdertiferTest3 = @"ConvertTwoCollectionViewCell";

@interface HDConvertController ()<UICollectionViewDelegate,UICollectionViewDataSource,UITextFieldDelegate>
@property (nonatomic ,strong)  UICollectionView * recommodCollectionView;
...
@implementation HDConvertController{
...
-(void)creatUI{
    ...
    _recommodCollectionView = [[UICollectionView alloc] initWithFrame: CGRectMake(0, KNAV_TOOL_HEIGHT, ScreenW, screenH -64 - 50) collectionViewLayout:flyout];
    
    [self.view addSubview:_recommodCollectionView];
    ...
    [_recommodCollectionView registerNib:[UINib nibWithNibName:@"GradeCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:GradeIdertiferTest];
    
    [_recommodCollectionView registerNib:[UINib nibWithNibName:@"ConvertOneCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:GradeIdertiferTest2];
    
    [_recommodCollectionView registerNib:[UINib nibWithNibName:@"ConvertTwoCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:GradeIdertiferTest3];
    
    [_recommodCollectionView registerClass:[ConvertCollectionReusableView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"headerView"];
    
     [_recommodCollectionView registerClass:[ConvertCollectionReusableView class] forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"footView"];


    //_recommodCollectionView.
    __weak typeof(self)weakself = self;
    
    weakself.recommodCollectionView.mj_header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
...
-(void)requestData{
    ...
    [weakself POST:integralGoodsUrl parameters:param success:^(id responseObject) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            [weakself.recommodCollectionView reloadData];
        });
        [weakself.recommodCollectionView.mj_header endRefreshing];
...
-(void)firstLoad{
    ...
    [weakself.recommodCollectionView.mj_header beginRefreshing];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        ...
        ConvertTwoCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:GradeIdertiferTest2 forIndexPath:indexPath];
        ...
        ConvertTwoCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:GradeIdertiferTest3 forIndexPath:indexPath];
        ...
        GradeCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:GradeIdertiferTest forIndexPath:indexPath];
...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        ...
        return CGSizeMake(ScreenW, 136 * ScreenScale);

    }else if (indexPath.section == 1){
        
        return CGSizeMake(ScreenW, 147);
...
-(UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 2) {
        ...
        if (kind == UICollectionElementKindSectionFooter) {
            ...
            ConvertCollectionReusableView * headerView =[collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"footView" forIndexPath:indexPath];
        ...
        ConvertCollectionReusableView * headerView =[collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"headerView" forIndexPath:indexPath];
        
        UIView * bgView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenW, 40)];
        //创建文字图片
       UIImageView * imageView = [[UIImageView alloc] initWithFrame:CGRectMake(10, 10, 18, 18)];
        UILabel * label = [[UILabel alloc] initWithFrame:CGRectMake(35, 0, 200, 40)];
        
        imageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"tj"]];
        [label setText:@"推荐兑换商品"];
