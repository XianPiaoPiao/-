...
#define SCREEN_BILI   Main_Screen_Width/375.
//
...
//广告bannaer 高度
#define KAdverHeight [UIScreen mainScreen].bounds.size.width*0.8
//导航栏高度
//导航栏高度
#define KNAV_TOOL_HEIGHT (isiPhoneX ? 88.0f : 64.0f)
#define KTABBAR_TOOL_HEIGHT (isiPhoneX ? 83.0f :49.0f)
...
[_table setSeparatorColor:[UIColor lineColor]];\
}\
